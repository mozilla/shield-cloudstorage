...
const UTILS_VERSION = __webpack_require__(8).version;
...
module.exports = {
	...
	"scripts": {
		"apiDocs": "node ./bin/documentSchema.js ./webExtensionApis/study/schema.json > docs/api.md ",
		"build": "cd webExtensionApis/study && webpack && yaml2json schema.yaml -p > schema.json && node ../../bin/verifyWeeSchema.js schema.json",
		...
		"postbuild": "npm run fakeApi && npm run apiDocs && npm run format # while we work out the api",
...
this.study = class extends ExtensionAPI {
  ...
  getAPI(context) {
    ...
    const studyUtilsBootstrap = __webpack_require__(1);
...
const Ajv = __webpack_require__(3);
const ajv = new Ajv();
